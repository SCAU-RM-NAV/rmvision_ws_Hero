...
#define NODE_MAIN_LOGGER_NAME "armor_creater_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libarmor_creater.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<rm_auto_aim::ArmorCreaterNode>";
