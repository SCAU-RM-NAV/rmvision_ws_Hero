...
class Armor(metaclass=Metaclass_Armor):
    ...
    def __init__(self, **kwargs):
        ...
        self.armor_ratio = kwargs.get('armor_ratio', float())
        from geometry_msgs.msg import Pose
    ...
    def __eq__(self, other):
        ...
        if self.distance_to_image_center != other.distance_to_image_center:
            return False
        if self.armor_ratio != other.armor_ratio:
            return False
    ...
    @builtins.property
    def armor_ratio(self):
        """Message field 'armor_ratio'."""
        return self._armor_ratio

    @armor_ratio.setter
    def armor_ratio(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'armor_ratio' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'armor_ratio' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._armor_ratio = value
