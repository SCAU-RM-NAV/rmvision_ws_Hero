...
bool auto_aim_interfaces__msg__tracker_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // sigma2_state
    PyObject * field = PyObject_GetAttrString(_pymsg, "sigma2_state");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      double * dest = ros_message->sigma2_state.data;
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'sigma2_state'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
...
PyObject * auto_aim_interfaces__msg__tracker_info__convert_to_py(void * raw_ros_message)
{
  ...
  {  // sigma2_state
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "sigma2_state");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->sigma2_state.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      double * src = &(ros_message->sigma2_state.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->sigma2_state.size * sizeof(double));
      assert(data != NULL);
