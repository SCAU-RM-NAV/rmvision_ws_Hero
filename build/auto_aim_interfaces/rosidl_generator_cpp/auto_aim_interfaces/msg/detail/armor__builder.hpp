...
class Init_Armor_armor_ratio
{
public:
  explicit Init_Armor_armor_ratio(::auto_aim_interfaces::msg::Armor & msg)
  : msg_(msg)
  {}
  Init_Armor_pose armor_ratio(::auto_aim_interfaces::msg::Armor::_armor_ratio_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_Armor_armor_ratio distance_to_image_center(::auto_aim_interfaces::msg::Armor::_distance_to_image_center_type arg)
  {
    msg_.distance_to_image_center = std::move(arg);
    return Init_Armor_armor_ratio(msg_);
  }
