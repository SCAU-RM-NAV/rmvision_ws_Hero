...
struct DebugArmor_
{
  ...
  using _armor_ratio_type =
    float;
  _armor_ratio_type armor_ratio;
  using _angle_type =
    float;
  _angle_type angle;
  ...
  Type & set__armor_ratio(
    const float & _arg)
  {
    this->armor_ratio = _arg;
    return *this;
  }
  Type & set__angle(
    const float & _arg)
  ...
  bool operator==(const DebugArmor_ & other) const
  {
    ...
    if (this->armor_ratio != other.armor_ratio) {
      return false;
    }
