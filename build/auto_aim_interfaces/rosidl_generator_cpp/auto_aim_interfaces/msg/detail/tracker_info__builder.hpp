...
class Init_TrackerInfo_sigma2_state
{
public:
  explicit Init_TrackerInfo_sigma2_state(::auto_aim_interfaces::msg::TrackerInfo & msg)
  : msg_(msg)
  {}
  ::auto_aim_interfaces::msg::TrackerInfo sigma2_state(::auto_aim_interfaces::msg::TrackerInfo::_sigma2_state_type arg)
  {
    msg_.sigma2_state = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_TrackerInfo_sigma2_state yaw(::auto_aim_interfaces::msg::TrackerInfo::_yaw_type arg)
  {
    msg_.yaw = std::move(arg);
    return Init_TrackerInfo_sigma2_state(msg_);
  }
