...
class Target(metaclass=Metaclass_Target):
    ...
    _fields_and_field_types = {
        ...
        'armor_position': 'geometry_msgs/Point',
    ...
    def __init__(self, **kwargs):
        ...
        self.armor_jump = kwargs.get('armor_jump', bool())
        ...
        from geometry_msgs.msg import Point
        self.armor_position = kwargs.get('armor_position', Point())
        from geometry_msgs.msg import Vector3
    ...
    def __eq__(self, other):
        ...
        if self.tracking != other.tracking:
            return False
        if self.armor_jump != other.armor_jump:
            return False
        if self.id != other.id:
            return False
    ...
    @builtins.property
    def armor_jump(self):
        """Message field 'armor_jump'."""
        return self._armor_jump

    @armor_jump.setter
    def armor_jump(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'armor_jump' field must be of type 'bool'"
        self._armor_jump = value
    ...
    def armor_position(self, value):
        if __debug__:
            ...
            assert \
                isinstance(value, Point), \
                "The 'armor_position' field must be a sub message of type 'Point'"
