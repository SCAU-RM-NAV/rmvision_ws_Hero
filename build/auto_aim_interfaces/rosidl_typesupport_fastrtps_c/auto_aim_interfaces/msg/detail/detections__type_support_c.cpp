...
#include "auto_aim_interfaces/msg/detail/detections__rosidl_typesupport_fastrtps_c.h"
...
#include "auto_aim_interfaces/msg/detail/detection__functions.h"  // detections
...
using _Detections__ros_msg_type = auto_aim_interfaces__msg__Detections;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: detections
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, auto_aim_interfaces, msg, Detection
      )()->data);
  ...
  // Field name: imu_to_camera
  {
    size_t size = 9;
    auto array_ptr = ros_message->imu_to_camera;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: detections
  {
    ...
    if (ros_message->detections.data) {
      auto_aim_interfaces__msg__Detection__Sequence__fini(&ros_message->detections);
    }
...
size_t get_serialized_size_auto_aim_interfaces__msg__Detections(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Detections__ros_msg_type * ros_message = static_cast<const _Detections__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name detections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_auto_aim_interfaces__msg__Detection(
...
static uint32_t _Detections__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_auto_aim_interfaces__msg__Detections(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_auto_aim_interfaces
size_t max_serialized_size_auto_aim_interfaces__msg__Detections(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: detections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_auto_aim_interfaces__msg__Detection(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = auto_aim_interfaces__msg__Detections;
    is_plain =
      (
...
static size_t _Detections__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_auto_aim_interfaces__msg__Detections(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, auto_aim_interfaces, msg, Detections)() {
