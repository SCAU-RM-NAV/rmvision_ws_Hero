...
#include "geometry_msgs/msg/detail/point__functions.h"  // armor_position, position
#include "geometry_msgs/msg/detail/vector3__functions.h"  // armor_velocity, velocity
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: armor_jump
  {
    cdr << (ros_message->armor_jump ? true : false);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: armor_jump
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->armor_jump = tmp ? true : false;
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name armor_jump
  {
    size_t item_size = sizeof(ros_message->armor_jump);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name id
