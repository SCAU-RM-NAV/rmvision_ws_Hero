...
#include "rosidl_runtime_c/primitives_sequence.h"  // sigma2_state
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // sigma2_state
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: sigma2_state
  {
    size_t size = ros_message->sigma2_state.size;
    auto array_ptr = ros_message->sigma2_state.data;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: sigma2_state
  {
    ...
    if (ros_message->sigma2_state.data) {
      rosidl_runtime_c__double__Sequence__fini(&ros_message->sigma2_state);
    }
    if (!rosidl_runtime_c__double__Sequence__init(&ros_message->sigma2_state, size)) {
      fprintf(stderr, "failed to create array for field 'sigma2_state'");
      return false;
    }
    auto array_ptr = ros_message->sigma2_state.data;
  ...
  size_t current_alignment)
{
  ...
  // field.name sigma2_state
  {
    size_t array_size = ros_message->sigma2_state.size;
    auto array_ptr = ros_message->sigma2_state.data;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    is_plain =
      (
      offsetof(DataType, sigma2_state) +
      last_member_size
      ) == ret_val;
  }
