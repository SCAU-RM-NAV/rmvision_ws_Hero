...
#include "auto_aim_interfaces/msg/detail/detection__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const auto_aim_interfaces::msg::KeyPointAndFloat &,
...
cdr_serialize(
  const auto_aim_interfaces::msg::Detection & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  auto_aim_interfaces::msg::Detection & ros_message)
{
  // Member: class_id
  cdr >> ros_message.class_id;
  ...
  size_t current_alignment)
{
  ...
  // Member: key_point
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        auto_aim_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_KeyPointAndFloat(
  ...
  if (is_plain) {
    ...
    using DataType = auto_aim_interfaces::msg::Detection;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const auto_aim_interfaces::msg::Detection *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<auto_aim_interfaces::msg::Detection *>(
    untyped_ros_message);
...
get_message_type_support_handle<auto_aim_interfaces::msg::Detection>()
{
  return &auto_aim_interfaces::msg::typesupport_fastrtps_cpp::_Detection__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, auto_aim_interfaces, msg, Detection)() {
  return &auto_aim_interfaces::msg::typesupport_fastrtps_cpp::_Detection__handle;
}
