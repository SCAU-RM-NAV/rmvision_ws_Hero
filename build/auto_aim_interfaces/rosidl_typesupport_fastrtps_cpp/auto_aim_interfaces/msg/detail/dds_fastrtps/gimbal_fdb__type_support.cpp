...
#include "auto_aim_interfaces/msg/detail/gimbal_fdb__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const auto_aim_interfaces::msg::GimbalFdb & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  auto_aim_interfaces::msg::GimbalFdb & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = auto_aim_interfaces::msg::GimbalFdb;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const auto_aim_interfaces::msg::GimbalFdb *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<auto_aim_interfaces::msg::GimbalFdb *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GimbalFdb__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const auto_aim_interfaces::msg::GimbalFdb *>(
...
static size_t _GimbalFdb__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GimbalFdb(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GimbalFdb__callbacks = {
...
static rosidl_message_type_support_t _GimbalFdb__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GimbalFdb__callbacks,
...
{
  return &auto_aim_interfaces::msg::typesupport_fastrtps_cpp::_GimbalFdb__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, auto_aim_interfaces, msg, GimbalFdb)() {
  return &auto_aim_interfaces::msg::typesupport_fastrtps_cpp::_GimbalFdb__handle;
}
