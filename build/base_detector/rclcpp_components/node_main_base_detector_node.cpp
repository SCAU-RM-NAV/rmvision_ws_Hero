...
#define NODE_MAIN_LOGGER_NAME "base_detector_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libbase_detector.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<rm_auto_aim::BaseDetectorNode>";
