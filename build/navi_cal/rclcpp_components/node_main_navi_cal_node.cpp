...
#define NODE_MAIN_LOGGER_NAME "navi_cal_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libnavi_cal.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<taurus::Navi_cal>";
