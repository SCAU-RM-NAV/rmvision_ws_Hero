...
#define NODE_MAIN_LOGGER_NAME "serial_driver_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libserial_driver.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<rm_auto_aim::SerialDriverNode>";
