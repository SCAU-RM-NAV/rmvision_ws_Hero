...
auto_aim_interfaces__msg__Base__create()
{
  ...
  auto_aim_interfaces__msg__Base * msg = (auto_aim_interfaces__msg__Base *)allocator.allocate(sizeof(auto_aim_interfaces__msg__Base), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(auto_aim_interfaces__msg__Base));
  bool success = auto_aim_interfaces__msg__Base__init(msg);
  if (!success) {
...
auto_aim_interfaces__msg__Base__destroy(auto_aim_interfaces__msg__Base * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    auto_aim_interfaces__msg__Base__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
auto_aim_interfaces__msg__Base__Sequence__init(auto_aim_interfaces__msg__Base__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  auto_aim_interfaces__msg__Base * data = NULL;

  if (size) {
    data = (auto_aim_interfaces__msg__Base *)allocator.zero_allocate(size, sizeof(auto_aim_interfaces__msg__Base), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = auto_aim_interfaces__msg__Base__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        auto_aim_interfaces__msg__Base__fini(&data[i - 1]);
      }
...
auto_aim_interfaces__msg__Base__Sequence__fini(auto_aim_interfaces__msg__Base__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      auto_aim_interfaces__msg__Base__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  auto_aim_interfaces__msg__Base__Sequence * array = (auto_aim_interfaces__msg__Base__Sequence *)allocator.allocate(sizeof(auto_aim_interfaces__msg__Base__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = auto_aim_interfaces__msg__Base__Sequence__init(array, size);
  if (!success) {
...
auto_aim_interfaces__msg__Base__Sequence__destroy(auto_aim_interfaces__msg__Base__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    auto_aim_interfaces__msg__Base__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
auto_aim_interfaces__msg__Base__Sequence__are_equal(const auto_aim_interfaces__msg__Base__Sequence * lhs, const auto_aim_interfaces__msg__Base__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!auto_aim_interfaces__msg__Base__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  auto_aim_interfaces__msg__Base__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(auto_aim_interfaces__msg__Base);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    auto_aim_interfaces__msg__Base * data =
      (auto_aim_interfaces__msg__Base *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!auto_aim_interfaces__msg__Base__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          auto_aim_interfaces__msg__Base__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!auto_aim_interfaces__msg__Base__copy(
