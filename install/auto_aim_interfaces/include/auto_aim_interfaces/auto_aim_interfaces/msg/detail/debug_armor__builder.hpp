...
class Init_DebugArmor_armor_ratio
{
public:
  explicit Init_DebugArmor_armor_ratio(::auto_aim_interfaces::msg::DebugArmor & msg)
  : msg_(msg)
  {}
  Init_DebugArmor_angle armor_ratio(::auto_aim_interfaces::msg::DebugArmor::_armor_ratio_type arg)
  {
    msg_.armor_ratio = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_DebugArmor_armor_ratio light_ratio(::auto_aim_interfaces::msg::DebugArmor::_light_ratio_type arg)
  {
    msg_.light_ratio = std::move(arg);
    return Init_DebugArmor_armor_ratio(msg_);
  }
